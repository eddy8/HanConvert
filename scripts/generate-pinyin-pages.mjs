...
const relatedLabels = {
  "zh-CN": [[slug, "汉字转拼音"], ["simplified-to-traditional", "简体转繁体"], ["traditional-to-simplified", "繁体转简体"], ["file-text-converter", "文件文本简繁转换"], ["japanese-chinese-kanji-converter", "日中汉字三体转换"], ["japanese-characters", "日文字符复制"]],
  "zh-TW": [[slug, "漢字轉拼音"], ["simplified-to-traditional", "簡體轉繁體"], ["traditional-to-simplified", "繁體轉簡體"], ["file-text-converter", "文件文字簡繁轉換"], ["japanese-chinese-kanji-converter", "日中漢字三體轉換"], ["japanese-characters", "日文字元複製"]],
  en: [[slug, "Chinese to Pinyin"], ["simplified-to-traditional", "Simplified to Traditional"], ["traditional-to-simplified", "Traditional to Simplified"], ["file-text-converter", "Document text converter"], ["japanese-chinese-kanji-converter", "Japanese and Chinese Kanji"], ["japanese-characters", "Japanese character copy"]],
  ja: [[slug, "中国語ピンイン変換"], ["simplified-to-traditional", "簡体字から繁体字"], ["traditional-to-simplified", "繁体字から簡体字"], ["file-text-converter", "文書テキスト変換"], ["japanese-chinese-kanji-converter", "日中漢字3種類変換"], ["japanese-characters", "日本語文字コピー"]],
  ko: [[slug, "중국어 병음 변환"], ["simplified-to-traditional", "간체를 번체로"], ["traditional-to-simplified", "번체를 간체로"], ["file-text-converter", "문서 텍스트 변환"], ["japanese-chinese-kanji-converter", "일본·중국 한자 변환"], ["japanese-characters", "일본어 문자 복사"]]
};
