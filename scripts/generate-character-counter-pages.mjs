...
const relatedLabels = {
  "zh-CN": [[slug, "在线字数统计"], ["text-formatter", "文本格式化与 AI 水印清理"], ["word-to-txt", "Word 转 TXT"], ["file-text-converter", "文件文本简繁转换"], ["chinese-to-pinyin", "汉字转拼音"], ["chinese-stroke-order", "汉字笔顺查询"], ["han-character-worksheet", "汉字练习纸"], ["kanji-to-romaji", "日文汉字转罗马字"], ["chinese-handwriting-recognition", "手写汉字识别"], ["chinese-character-lookup", "汉字查询与结构拆解"], ["simplified-to-traditional", "简体转繁体"], ["japanese-chinese-kanji-converter", "日中汉字三体转换"], ["japanese-characters", "日文字符复制"]],
  "zh-TW": [[slug, "線上字數統計"], ["text-formatter", "文字格式化與 AI 浮水印清理"], ["word-to-txt", "DOCX 轉 TXT"], ["file-text-converter", "文件文字簡繁轉換"], ["chinese-to-pinyin", "漢字轉拼音"], ["chinese-stroke-order", "漢字筆順查詢"], ["han-character-worksheet", "國字練習紙"], ["kanji-to-romaji", "日文漢字轉羅馬字"], ["chinese-handwriting-recognition", "手寫漢字辨識"], ["chinese-character-lookup", "漢字查詢與結構拆解"], ["simplified-to-traditional", "簡體轉繁體"], ["japanese-chinese-kanji-converter", "日中漢字三體轉換"], ["japanese-characters", "日文字元複製"]],
  en: [[slug, "CJK character counter"], ["text-formatter", "Text formatter and AI watermark cleaner"], ["word-to-txt", "Word to text"], ["file-text-converter", "Document Chinese converter"], ["chinese-to-pinyin", "Chinese to Pinyin"], ["chinese-stroke-order", "Chinese stroke order"], ["han-character-worksheet", "Chinese worksheet generator"], ["kanji-to-romaji", "Kanji to Romaji"], ["chinese-handwriting-recognition", "Chinese handwriting recognition"], ["chinese-character-lookup", "Chinese character lookup"], ["simplified-to-traditional", "Simplified to Traditional"], ["japanese-chinese-kanji-converter", "Japanese and Chinese Kanji"], ["japanese-characters", "Japanese character copy"]],
  ja: [[slug, "文字数カウント"], ["text-formatter", "テキスト整形・AI透かし削除"], ["word-to-txt", "Word TXT 変換"], ["file-text-converter", "文書の中国語簡繁変換"], ["japanese-characters", "日本語文字コピー"], ["japanese-kanji-converter", "旧字体 新字体 変換"], ["chinese-to-pinyin", "中国語ピンイン変換"], ["chinese-stroke-order", "中国語漢字の筆順"], ["han-character-worksheet", "漢字練習プリント"], ["kanji-to-romaji", "漢字・ローマ字変換"], ["chinese-handwriting-recognition", "中国語の手書き漢字検索"], ["chinese-character-lookup", "漢字の構成・部首検索"], ["japanese-chinese-kanji-converter", "日中漢字3種類変換"]],
  ko: [[slug, "글자수 세기"], ["text-formatter", "텍스트 정리·AI 워터마크 제거"], ["word-to-txt", "DOCX TXT 변환"], ["file-text-converter", "문서 중국어 변환"], ["japanese-characters", "일본어 문자 복사"], ["chinese-to-pinyin", "중국어 병음 변환"], ["chinese-stroke-order", "중국어 한자 필순"], ["han-character-worksheet", "한자 쓰기 연습장"], ["kanji-to-romaji", "일본어 한자 로마자 변환"], ["chinese-handwriting-recognition", "손글씨 한자 인식"], ["chinese-character-lookup", "한자 부수·구성요소 검색"], ["japanese-chinese-kanji-converter", "일본·중국 한자 변환"], ["simplified-to-traditional", "간체를 번체로"]]
};
