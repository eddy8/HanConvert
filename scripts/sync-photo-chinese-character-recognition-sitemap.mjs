...
const markerStart = "  <!-- photo-chinese-character-recognition:start -->";
const markerEnd = "  <!-- photo-chinese-character-recognition:end -->";
const locales = [
...
console.log("Added 5 photo Chinese-character-recognition URLs to sitemap.xml.");
