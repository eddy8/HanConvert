...
const blogGuide = `      <!-- blog-guide-links:start -->
      <section class="tool-guide-strip" aria-labelledby="blogGuideTitle">
        <div><p class="section-kicker">使用指南</p><h2 id="blogGuideTitle">拍照识字还是手写汉字识别</h2><p>比较图片 OCR 和笔画轨迹识别的适用场景、隐私处理与提高成功率的方法。</p></div>
        <a href="/blog/photo-vs-handwriting-chinese-recognition/">阅读完整指南 <span aria-hidden="true">→</span></a>
      </section>
      <!-- blog-guide-links:end -->`;

const locales = {
  "zh-CN": { prefix: "", lang: "zh-CN", hreflang: "zh-Hans", label: "简体中文", home: "网站首页", skip: "跳到主要内容", language: "界面语言", header: "网站页眉", nav: "主要导航", footer: "页脚", about: "关于我们", contact: "联系我们", privacy: "隐私声明", errorTitle: "识别失败", close: "关闭" },
  "zh-TW": { prefix: "zh-tw/", lang: "zh-Hant", hreflang: "zh-Hant", label: "繁體中文", home: "網站首頁", skip: "跳到主要內容", language: "介面語言", header: "網站頁首", nav: "主要導覽", footer: "頁尾", about: "關於我們", contact: "聯絡我們", privacy: "隱私聲明", errorTitle: "辨識失敗", close: "關閉" },
  en: { prefix: "en/", lang: "en", hreflang: "en", label: "English", home: "Home", skip: "Skip to main content", language: "Language", header: "Site header", nav: "Primary navigation", footer: "Footer", about: "About", contact: "Contact", privacy: "Privacy Statement", errorTitle: "Recognition failed", close: "Close" },
  ja: { prefix: "ja/", lang: "ja", hreflang: "ja", label: "日本語", home: "ホーム", skip: "メインコンテンツへ移動", language: "表示言語", header: "サイトヘッダー", nav: "メインナビゲーション", footer: "フッター", about: "JianFan.app について", contact: "お問い合わせ", privacy: "プライバシー声明", errorTitle: "認識に失敗しました", close: "閉じる" },
  ko: { prefix: "ko/", lang: "ko", hreflang: "ko", label: "한국어", home: "홈", skip: "주요 내용으로 이동", language: "언어", header: "사이트 헤더", nav: "주요 탐색", footer: "바닥글", about: "소개", contact: "문의", privacy: "개인정보 보호 안내", errorTitle: "인식에 실패했습니다", close: "닫기" }
};
...
const content = {
  "zh-CN": {
    ...
    featureKicker: "拍照识字 · 图片转文字 · 拍照查字",
    featureTitle: "从照片和图片提取汉字，再逐字查询",
    featureIntro: "在线拍照汉字识别也可作为中文图片转文字和图片文字识别工具，适合处理书籍、菜单、路牌、课堂资料、截图与扫描件。它能提取图片中的简体字或繁体字，并把 OCR 结果连接到拼音、笔顺与汉字结构工具。",
    cards: [
  ...
  "zh-TW": {
    ...
    featureKicker: "拍照識字 · 圖片轉文字 · 拍照查字",
    featureTitle: "從照片和圖片擷取漢字，再逐字查詢",
    featureIntro: "線上拍照漢字辨識也能作為中文圖片轉文字與圖片文字辨識工具，適合處理書籍、菜單、路牌、課堂資料、截圖和掃描檔。它可擷取圖片中的正體字或簡體字，並由 OCR 結果直接查詢拼音、筆順與漢字結構。",
    ...
    faqTitle: "拍照漢字辨識常見問題",
    faqs: [["可以一次辨識多個漢字嗎？", "可以。圖片可包含單字、詞語或多行文字；回傳多字結果時，可複製全文，也能點選任一漢字查字。"], ["支援正體字和簡體字嗎？", "支援常見正體字和簡體字。模糊照片、藝術字、嚴重傾斜、反光或複雜背景可能影響中文 OCR 結果。"], ["圖片會在本機辨識嗎？", "不會完全在本機辨識。自動裁切和壓縮在瀏覽器中完成，處理後的圖片會上傳到 JianFan.app OCR 服務。"], ["拍照辨識和手寫辨識有何不同？", "本頁讀取照片或截圖中的漢字；手寫辨識頁則是在田字格逐畫書寫，依筆畫軌跡比對一個漢字。"], ["可以把圖片中的中文轉成可複製文字嗎？", "可以。本工具可用於中文圖片轉文字、圖片文字辨識和從圖片擷取文字，從手機照片、截圖或掃描檔擷取正體字與簡體字，結果可整段複製。"]],
    related: "相關漢字工具",
    relatedAria: "相關漢字與文字工具",
    links: [["image-redaction", "線上圖片打馬賽克"], ["chinese-handwriting-recognition", "手寫漢字辨識"], ["chinese-character-lookup", "漢字查詢與結構拆解"], ["chinese-stroke-order", "漢字筆順查詢"], ["chinese-to-pinyin", "漢字轉拼音"], ["han-character-worksheet", "國字練習紙"]],
    footerText: "JianFan.app 提供拍照識字、手寫查字、拼音、筆順與中文轉換工具。",
    messages: {
      waiting: "等待選擇圖片", processingImage: "正在自動裁切並壓縮圖片", imageReady: "圖片已處理，可以開始辨識", compressionFailed: "圖片處理後仍超過 2 MB，請重新拍攝或選擇圖片", emptyImage: "圖片內容為空，請重新選擇", sourceTooLarge: "原始圖片不能超過 24 MB", unsupportedImage: "僅支援 PNG、JPEG、WebP、HEIC 或 HEIF 圖片", imageSelected: "圖片已選擇", emptyPreviewTitle: "拍照或選擇圖片", emptyPreviewBody: "支援手機相機、相簿和電腦圖片", uploading: "正在上傳並辨識圖片", recognizing: "正在辨識圖片中的漢字…", recognizedCharacter: "已辨識為「{character}」", recognizedText: "已辨識出漢字文字", noText: "辨識服務沒有回傳可用的漢字文字", timeout: "辨識逾時，請檢查網路後再試一次", networkError: "無法連線辨識服務，請檢查網路後再試一次", authError: "辨識服務驗證失敗", uploadTooLarge: "處理後的圖片超過 2 MB，請重新拍攝或選擇圖片", rateLimited: "辨識次數過多，請稍後再試", serviceUnavailable: "辨識服務暫時無法使用，請稍後再試", resultEmpty: "選擇圖片後，點選「辨識圖片中的漢字」。", resultSummary: "辨識到 {count} 個漢字", selectCharacter: "查詢漢字「{character}」", copiedText: "已複製辨識文字", copiedCharacter: "已複製「{character}」", copyFailed: "自動複製失敗，請直接選取文字複製", recognitionFailed: "辨識失敗"
    }
  },
  en: {
    title: "Chinese OCR Online - Image to Text & Hanzi Lookup | JianFan.app",
    alternateNames: ["Chinese photo OCR", "Recognize Chinese characters from image", "Hanzi image to text", "Chinese OCR online", "Chinese image to text"],
    ...
    featureKicker: "Chinese OCR · Image to text · Hanzi lookup",
    featureTitle: "Extract Chinese text from images, then inspect each Hanzi",
    featureIntro: "Use this Chinese OCR online and image-to-text tool for books, menus, signs, study sheets, screenshots and scanned pages. It extracts Simplified or Traditional Chinese text from images and connects each recognized Hanzi to Pinyin, stroke order and character structure.",
  ...
  ja: {
    ...
    featureKicker: "中国語画像OCR・画像テキスト化",
    featureTitle: "写真から中国語テキストを抽出し、漢字を検索",
    featureIntro: "中国語の画像から文字起こししたいときに、書籍、メニュー、看板、学習プリント、スクリーンショット、スキャン画像を利用できます。簡体字・繁体字をコピー可能なテキストへ変換し、認識結果からピンイン、筆順、漢字の構成も検索できます。",
    ...
    faqs: [["複数の漢字を一度に認識できますか？", "はい。1文字、単語、複数行の画像に対応します。結果全体をコピーするほか、各漢字を選んで詳しく調べられます。"], ["簡体字と繁体字に対応していますか？", "一般的な簡体字・繁体字に対応します。ぼけ、装飾文字、反射、強い傾き、複雑な背景は認識精度を下げる場合があります。"], ["画像認識はブラウザー内だけで行われますか？", "いいえ。トリミングと圧縮はブラウザー内で行い、処理済み画像を JianFan.app OCR サービスへ送信して認識します。"], ["手書き漢字検索との違いは？", "このページは写真やスクリーンショットを読み取ります。手書き検索はマスに1画ずつ書いた筆跡から漢字候補を探します。"], ["中国語の画像をテキスト化できますか？", "はい。中国語画像OCRとして、写真、スクリーンショット、スキャン画像から簡体字・繁体字を抽出できます。結果全体をコピーするほか、漢字ごとの検索も可能です。"]],
    related: "関連する漢字ツール",
    relatedAria: "関連する中国語漢字ツール",
    links: [["image-redaction", "画像モザイク加工"], ["chinese-handwriting-recognition", "中国語の手書き漢字検索"], ["chinese-character-lookup", "漢字の構成・部首検索"], ["chinese-stroke-order", "中国語漢字の筆順"], ["chinese-to-pinyin", "中国語ピンイン変換"], ["han-character-worksheet", "漢字練習プリント"]],
    footerText: "JianFan.app は中国語画像OCR、手書き検索、ピンイン、筆順、文字変換ツールを提供します。",
    messages: {
      waiting: "画像を選択してください", processingImage: "画像をトリミング・圧縮しています", imageReady: "画像の準備ができました", compressionFailed: "処理後の画像が2 MBを超えています。撮り直すか、別の画像を選んでください", emptyImage: "画像が空です。別の画像を選んでください", sourceTooLarge: "元画像は24 MB以下にしてください", unsupportedImage: "PNG、JPEG、WebP、HEIC、HEIF画像を使用してください", imageSelected: "画像を選択しました", emptyPreviewTitle: "撮影または画像を選択", emptyPreviewBody: "カメラ、写真ライブラリ、パソコンの画像に対応", uploading: "画像を送信して認識しています", recognizing: "画像の漢字を認識しています…", recognizedCharacter: "「{character}」と認識しました", recognizedText: "中国語テキストを認識しました", noText: "利用できる漢字テキストが返されませんでした", timeout: "認識がタイムアウトしました。通信を確認してもう一度お試しください", networkError: "認識サービスに接続できません。通信を確認してもう一度お試しください", authError: "認識サービスの認証に失敗しました", uploadTooLarge: "処理後の画像が2 MBを超えています。撮り直すか、別の画像を選んでください", rateLimited: "認識回数が上限に達しました。しばらくしてからもう一度お試しください", serviceUnavailable: "認識サービスを一時的に利用できません。後でもう一度お試しください", resultEmpty: "画像を選び、「画像の漢字を認識」を押してください。", resultSummary: "漢字を {count} 文字認識しました", selectCharacter: "漢字「{character}」を調べる", copiedText: "認識結果をコピーしました", copiedCharacter: "「{character}」をコピーしました", copyFailed: "自動コピーに失敗しました。文字を選択してコピーしてください", recognitionFailed: "認識に失敗しました"
    }
  },
  ko: {
    title: "중국어 이미지 OCR - 사진 한자 인식·텍스트 추출 | JianFan.app",
    alternateNames: ["중국어 이미지 OCR", "사진 한자 인식", "이미지 한자 텍스트 변환", "이미지 텍스트 추출", "사진으로 한자 찾기"],
    ...
    featureKicker: "중국어 이미지 OCR·이미지 텍스트 추출",
    featureTitle: "사진에서 중국어 텍스트를 추출하고 한자 찾기",
    featureIntro: "사진으로 한자 찾기나 중국어 이미지 텍스트 추출이 필요할 때 책, 메뉴판, 간판, 학습 자료, 스크린샷과 스캔 이미지를 이용하세요. 간체자와 번체자를 복사 가능한 텍스트로 바꾸고, 인식된 한자에서 병음, 필순과 글자 구조를 바로 찾을 수 있습니다.",
...
${locale === "zh-CN" ? blogGuide : ""}
    ...
    <dialog class="photo-ocr-error-dialog" id="photoOcrErrorDialog" aria-labelledby="photoOcrErrorTitle"><form method="dialog"><h2 id="photoOcrErrorTitle">${meta.errorTitle}</h2><p id="photoOcrErrorMessage"></p><button type="submit">${meta.close}</button></form></dialog>
  </body>
</html>
`;
}
