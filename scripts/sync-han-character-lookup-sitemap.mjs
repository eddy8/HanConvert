...
const markerStart = "  <!-- han-character-lookup-tool:start -->";
const markerEnd = "  <!-- han-character-lookup-tool:end -->";
const locales = [
...
console.log("Added 5 Han-character lookup URLs to sitemap.xml.");
