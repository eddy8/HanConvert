...
const localeData = {
  "zh-CN": { prefix: "", chinese: "日中汉字三体转换", characters: "日文字符复制", pinyin: "汉字转拼音", strokeOrder: "汉字笔顺查询", worksheet: "汉字练习纸", wordToTxt: "Word 转 TXT", characterCounter: "在线字数统计" },
  "zh-TW": { prefix: "zh-tw/", chinese: "日中漢字三體轉換", characters: "日文字元複製", pinyin: "漢字轉拼音", strokeOrder: "漢字筆順查詢", worksheet: "國字練習紙", wordToTxt: "DOCX 轉 TXT", characterCounter: "線上字數統計" },
  en: { prefix: "en/", chinese: "Japanese and Chinese Kanji", characters: "Japanese character copy", pinyin: "Chinese to Pinyin", strokeOrder: "Chinese stroke order", worksheet: "Chinese worksheet generator", wordToTxt: "Word to text", characterCounter: "CJK character counter" },
  ja: { prefix: "ja/", chinese: "日本語漢字・簡体字・繁体字変換", characters: "日本語文字コピー", pinyin: "中国語ピンイン変換", strokeOrder: "中国語漢字の筆順", worksheet: "漢字練習プリント", wordToTxt: "Word TXT 変換", characterCounter: "文字数カウント" },
  ko: { prefix: "ko/", chinese: "일본·중국 한자 변환", characters: "일본어 문자 복사", pinyin: "중국어 병음 변환", strokeOrder: "중국어 한자 필순", worksheet: "한자 쓰기 연습장", wordToTxt: "DOCX TXT 변환", characterCounter: "글자수 세기" }
};
