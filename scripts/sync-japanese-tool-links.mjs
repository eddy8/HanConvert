...
const localeData = {
  "zh-CN": { prefix: "", chinese: "日中汉字三体转换", characters: "日文字符复制", pinyin: "汉字转拼音" },
  "zh-TW": { prefix: "zh-tw/", chinese: "日中漢字三體轉換", characters: "日文字元複製", pinyin: "漢字轉拼音" },
  en: { prefix: "en/", chinese: "Japanese and Chinese Kanji", characters: "Japanese character copy", pinyin: "Chinese to Pinyin" },
  ja: { prefix: "ja/", chinese: "日本語漢字・簡体字・繁体字変換", characters: "日本語文字コピー", pinyin: "中国語ピンイン変換" },
  ko: { prefix: "ko/", chinese: "일본·중국 한자 변환", characters: "일본어 문자 복사", pinyin: "중국어 병음 변환" }
};
