...
const translations = {
  "zh-CN": {
    ...
    seoAppTitle: "简体转繁体 APP 与繁体转简体 APP",
    seoAppBody: "适合经常处理中文文本的 macOS 和 Windows 用户，安装后可从桌面直接打开，文本转换仍在本机完成。",
    linkS2T: "简体转繁体",
    linkT2S: "繁体转简体",
    linkTaiwan: "台湾繁体转换",
    linkHongKong: "香港繁体转换",
    ...
    linkKanjiRomaji: "日文汉字转罗马字",
    linkKanjiHiragana: "汉字转平假名与振假名",
    linkJapaneseStrokeOrder: "日本汉字笔顺",
    linkJapaneseKanjiDictionary: "日本汉字字典",
    linkJapaneseHandwriting: "日文手写查字",
    linkPinyin: "汉字转拼音",
    linkStrokeOrder: "汉字笔顺查询",
    linkHandwriting: "手写汉字识别",
    linkWorksheet: "汉字练习纸",
  ...
  "zh-TW": {
    ...
    seoAppTitle: "簡體轉繁體 APP 與繁體轉簡體 APP",
    seoAppBody: "適合經常處理中文文字的 macOS 與 Windows 使用者，安裝後可直接從桌面開啟，文字轉換仍在本機完成。",
    linkS2T: "簡體轉繁體",
    linkT2S: "繁體轉簡體",
    linkTaiwan: "台灣繁體轉換",
    linkHongKong: "香港繁體轉換",
    ...
    linkKanjiRomaji: "日文漢字轉羅馬字",
    linkKanjiHiragana: "漢字轉平假名與振假名",
    linkJapaneseStrokeOrder: "日本漢字筆順",
    linkJapaneseKanjiDictionary: "日本漢字字典",
    linkJapaneseHandwriting: "日文手寫查字",
    linkPinyin: "漢字轉拼音",
    linkStrokeOrder: "漢字筆順查詢",
    linkHandwriting: "手寫漢字辨識",
    linkWorksheet: "國字練習紙",
  ...
  en: {
    ...
    seoAppTitle: "Simplified and Traditional Chinese converter app",
    seoAppBody: "For frequent use on macOS and Windows, the JianFan desktop app opens directly from your computer and keeps text conversion on your device.",
    ...
    linkKanjiRomaji: "Kanji to Romaji",
    linkKanjiHiragana: "Kanji to Hiragana & Furigana",
    linkJapaneseStrokeOrder: "Japanese Kanji stroke order",
    linkJapaneseKanjiDictionary: "Japanese Kanji dictionary",
    linkJapaneseHandwriting: "Japanese handwriting lookup",
    linkPinyin: "Chinese to Pinyin",
    linkStrokeOrder: "Chinese stroke order",
    linkHandwriting: "Chinese handwriting recognition",
  ...
  ja: {
    ...
    seoAppTitle: "中国語の簡体字・繁体字変換アプリ",
    seoAppBody: "macOS と Windows で中国語テキストを頻繁に変換する方向けのデスクトップアプリです。変換処理は端末内で行われます。",
    linkS2T: "簡体字から繁体字",
    linkT2S: "繁体字から簡体字",
    ...
    linkKanjiRomaji: "漢字・ローマ字変換",
    linkKanjiHiragana: "漢字をひらがな・ふりがなに変換",
    linkJapaneseStrokeOrder: "漢字の書き順・筆順",
    linkJapaneseKanjiDictionary: "漢字検索・漢字辞典",
    linkJapaneseHandwriting: "手書き漢字検索",
    linkPinyin: "中国語ピンイン変換",
    linkStrokeOrder: "中国語漢字の筆順",
    linkHandwriting: "漢字手書き検索",
  ...
  ko: {
    ...
    seoAppTitle: "중국어 간체·번체 변환 앱",
    seoAppBody: "macOS와 Windows에서 중국어 텍스트를 자주 변환하는 사용자를 위한 데스크톱 앱이며 변환은 기기에서 처리됩니다.",
    linkS2T: "간체를 번체로",
    linkT2S: "번체를 간체로",
    linkTaiwan: "대만 번체 변환",
    ...
    linkKanjiRomaji: "일본어 한자 로마자 변환",
    linkKanjiHiragana: "한자를 히라가나·후리가나로",
    linkJapaneseStrokeOrder: "일본 한자 필순",
    linkJapaneseKanjiDictionary: "일본 한자 사전",
    linkJapaneseHandwriting: "일본 한자 손글씨 검색",
    linkPinyin: "중국어 병음 변환",
    linkStrokeOrder: "중국어 한자 필순",
    linkHandwriting: "한자 필기 인식",
